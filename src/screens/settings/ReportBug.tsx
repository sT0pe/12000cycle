		...
		if (isValid) {
			try {
				await send(
					...
					process.env.EXPO_PUBLIC_EMAILJS_TEMPLATE_REPORT as string,
					{
      ...
      <View style={styles.container}>
				{messageSent ? (
					<View style={styles.header}>
						<Text style={styles.sent}>{t('reportBug.messageSent')}</Text>
					</View>
				) : (
					<KeyboardAwareScrollView>
						<View style={styles.header}>
							<Text style={styles.title}>{t('reportBug.title')}</Text>
							<Text style={styles.subtitle}>
								{t('reportBug.info')}
							</Text>
							<Text style={styles.stepTitle}>1. {t('reportBug.step-1')}</Text>
							<Text style={styles.stepText}>{t('reportBug.step-1-info')}</Text>
							<Text style={styles.stepTitle}>2. {t('reportBug.step-2')}</Text>
							<Text style={styles.stepText}>{t('reportBug.step-2-info')}</Text>
						</View>
						<View style={styles.form}>
							...
							<View style={styles.input}>
								<Text style={styles.inputLabel}>{t('reportBug.contactsTitle')}</Text>
								<Text style={styles.subtitle}>{t('reportBug.contactsText')}</Text>
							</View>
