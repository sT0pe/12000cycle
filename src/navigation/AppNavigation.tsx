	...
	return (
		<NavigationContainer>
			...
			>
				...
				/>
				<Drawer.Screen
					name={ROUTES.kitStack}
					component={KitNavigation}
					options={{
						title: t(`routes.${ROUTES.kit}`),
						drawerIcon: ({ color, size }) => <MaterialCommunityIcons name="bag-personal-outline" size={size - 5} color={color} />,
						drawerLabel: ({ color }) => <DrawerLabel color={color} label={t(`routes.${ROUTES.kit}`)} />,
					}}
				/>
				<Drawer.Screen
